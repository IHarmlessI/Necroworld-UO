...
namespace Server.Engines.Harvest
{
    public class Lumberjacking : HarvestSystem
    {
        ...
        private Lumberjacking()
        {
            ...
            // Every bank holds from 20 to 60 logs
            lumber.MinTotal = 30;
            lumber.MaxTotal = 60;
            ...
            if (Core.ML)
            {
                res = new HarvestResource[]
                {
                    ...
                    new HarvestResource(50.0, 25.0, 105.0, 1072541, typeof(OakLog)),
                    new HarvestResource(60.0, 40.0, 120.0, 1072542, typeof(AshLog)),
                    new HarvestResource(70.0, 55.0, 135.0, 1072543, typeof(YewLog)),
                    new HarvestResource(80.0, 60.0, 140.0, 1072544, typeof(HeartwoodLog)),
                    new HarvestResource(90.0, 60.0, 140.0, 1072545, typeof(BloodwoodLog)),
