...
namespace Server.Items
{
    ...
    public static class TreasureMapInfo
    {
        ...
        public static int GetGoldCount(TreasureLevel level)
        {
            ...
            {
                default:
                case TreasureLevel.Stash: return Utility.RandomMinMax(3000, 5000);
                case TreasureLevel.Supply: return Utility.RandomMinMax(5000, 9000);
                case TreasureLevel.Cache: return Utility.RandomMinMax(12000, 20000);
                case TreasureLevel.Hoard: return Utility.RandomMinMax(35000, 50000);
        ...
        public static int GetSpecialResourceAmount(ChestQuality quality)
        {
            ...
            {
                default:
                case ChestQuality.Rusty: return Utility.RandomMinMax(1, 3);
                case ChestQuality.Standard: return Utility.RandomMinMax(2, 4);
                case ChestQuality.Gold: return Utility.RandomMinMax(2, 5);
            }
        }
        ...
        public static int GetEquipmentAmount(Mobile from, TreasureLevel level, TreasurePackage package)
        {
            ...
            {
                default:
                case TreasureLevel.Stash: amount = 8; break;
                case TreasureLevel.Supply: amount = 10; break;
                case TreasureLevel.Cache: amount = package == TreasurePackage.Assassin ? 24 : 14; break;
        ...
        public static SkillName[][] _PowerscrollTable = new SkillName[][]
            {
                new SkillName[] { SkillName.Blacksmith, SkillName.Carpentry, SkillName.Cartography, SkillName.Mining, SkillName.Tailoring, SkillName.Lumberjacking, SkillName.Fletching },
        ...
        public static void Fill(Mobile from, TreasureMapChest chest, TreasureMap tMap)
        {
            ...
            chest.MaxLockLevel = chest.RequiredSkill + 10;
            ...
            switch (level)
            {
                case TreasureLevel.Stash: dropChance = 0.1; break;
                case TreasureLevel.Supply: dropChance = 0.3; break;
                case TreasureLevel.Cache: dropChance = 0.5; break;
                case TreasureLevel.Hoard: dropChance = 0.7; break;
                case TreasureLevel.Trove: dropChance = 0.9; break;
            }
            ...
            switch (level)
            {
                case TreasureLevel.Stash: dropChance = 0.05; break;
                case TreasureLevel.Supply: dropChance = 0.15; break;
                case TreasureLevel.Cache: dropChance = 0.25; break;
