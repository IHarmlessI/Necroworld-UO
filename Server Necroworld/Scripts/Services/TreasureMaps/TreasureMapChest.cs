    ...
    public class TreasureMapChest : LockableContainer
    {
        ...
        public static void Fill(Mobile from, LockableContainer cont, int level, bool isSos)
        {
            ...
            else
            {
                ...
                #region Gold
                cont.DropItem(new Gold(isSos ? count = Utility.RandomMinMax(3000, 5000)*level : count = Utility.RandomMinMax(3000, 5000)*level));
                #endregion
                ...
                if (Core.SE)
                {
                    ...
                    {
                        case 1:
                            count = isSos ? Utility.RandomMinMax(2, 6) : 56;
							propsScale = 0.5625;
                            break;
                        case 2:
                            count = isSos ? Utility.RandomMinMax(3, 7) : 64;
							propsScale = 0.6875;
                            break;
                        case 3:
                            count = isSos ? Utility.RandomMinMax(4, 8) : 72;
							propsScale = 0.875;
                            break;
                        case 4:
                            count = isSos ? Utility.RandomMinMax(10, 12) : 80;
                            break;
                        case 5:
                            count = isSos ? Utility.RandomMinMax(15, 20) : 88;
                            break;
                        case 6:
                            count = isSos ? Utility.RandomMinMax(18, 22) : 90;
                            break;
                        case 7:
                            count = isSos ? Utility.RandomMinMax(20, 24) : 100;
                            break;
                        default:
                            count = 0;
                            break;
