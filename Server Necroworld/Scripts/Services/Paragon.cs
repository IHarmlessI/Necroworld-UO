...
namespace Server.Mobiles
{
    ...
    {
        public static double ChestChance = .40;// Chance that a paragon will carry a paragon chest
        ...
        public static int Hue = 0x5AF;// Paragon hue
        ...
        public static bool CheckConvert(BaseCreature bc, Point3D location, Map m)
        {
            ...
            double chance = 1/ Math.Round(20.0 - 1.5*(fame / 3200));
