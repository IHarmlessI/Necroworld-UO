        ...
        public static WeaponAbility[] WepAbility12 =
{
        ...
        public static void LoadDefinitions()
        {
            ...
            Definitions = new TrainingDefinition[]
            {
                ...
                new TrainingDefinition(typeof(GhostWolf), Class.MagicalClawedAndTailed, MagicalAbility.Cusidhe, SpecialAbilityClawedTailedAndMagical2, WepAbility5, AreaEffectArea1, 5, 7), 
                ...
                new TrainingDefinition(typeof(IceBeetle), Class.Insectoid, MagicalAbility.StandardClawedOrTailed, SpecialAbilityMagicalInsectoid, WepAbility1, AreaEffectNone, 3, 5),
                new TrainingDefinition(typeof(StarBeetle), Class.Insectoid, MagicalAbility.StandardClawedOrTailed, SpecialAbilityMagicalInsectoid, WepAbility1, AreaEffectNone, 4, 6),
                new TrainingDefinition(typeof(WhiteBeetle), Class.Insectoid, MagicalAbility.StandardClawedOrTailed, SpecialAbilityMagicalInsectoid, WepAbility1, AreaEffectNone, 1, 5),
                ...
                new TrainingDefinition(typeof(SnowHiryu), Class.ClawedTailedMagicalAndTokuno, MagicalAbility.Hiryu, SpecialAbilityNone, WepAbility7, AreaEffectArea1, 5, 7),
                new TrainingDefinition(typeof(swampHiryu), Class.ClawedTailedMagicalAndTokuno, MagicalAbility.Hiryu, SpecialAbilityNone, WepAbility7, AreaEffectArea1, 5, 7),
                ...
                new TrainingDefinition(typeof(Swamphorse), Class.None, MagicalAbility.StandardClawedOrTailed, SpecialAbilityAnimalStandard, WepAbility1, AreaEffectNone, 1, 3),
                new TrainingDefinition(typeof(Daemonhorse), Class.None, MagicalAbility.StandardClawedOrTailed, SpecialAbilityAnimalStandard, WepAbility1, AreaEffectNone, 1, 3),
                new TrainingDefinition(typeof(Undeadsteed), Class.None, MagicalAbility.StandardClawedOrTailed, SpecialAbilityAnimalStandard, WepAbility1, AreaEffectNone, 1, 5),
                new TrainingDefinition(typeof(Plaguesteed), Class.None, MagicalAbility.StandardClawedOrTailed, SpecialAbilityAnimalStandard, WepAbility1, AreaEffectNone, 1, 5),
                ...
                new TrainingDefinition(typeof(Coldlight), Class.MagicalAndNecromantic, MagicalAbility.Variety2, SpecialAbilityNone, WepAbility2, AreaEffectArea1, 4, 6),
                new TrainingDefinition(typeof(Sunshine), Class.MagicalAndNecromantic, MagicalAbility.Variety2, SpecialAbilityNone, WepAbility2, AreaEffectArea1, 3, 5),
                ...
                new TrainingDefinition(typeof(BloodDragon), Class.Untrainable, MagicalAbility.None, SpecialAbilityNone, WepAbilityNone, AreaEffectNone, 1, 4),
                new TrainingDefinition(typeof(LavaDragon), Class.Untrainable, MagicalAbility.None, SpecialAbilityNone, WepAbilityNone, AreaEffectNone, 1, 4),
