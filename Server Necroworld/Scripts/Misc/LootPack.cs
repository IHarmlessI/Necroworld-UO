...
namespace Server
{
	public class LootPack
	{
		...
		public static readonly LootPackItem[] OldMagicItems = new[]
		{
			...
			new LootPackItem(typeof(BaseShield), 1), new LootPackItem(typeof(BaseClothing), 1)
		};
		#endregion
		...
		public static readonly LootPackItem[] AosMagicItemsPoor = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 2), new LootPackItem(typeof(BaseClothing), 1)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsMeagerType1 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 42), new LootPackItem(typeof(BaseClothing), 20)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsMeagerType2 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 21), new LootPackItem(typeof(BaseClothing), 20)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsAverageType1 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 68), new LootPackItem(typeof(BaseClothing), 40)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsAverageType2 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 40), new LootPackItem(typeof(BaseClothing), 40)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsRichType1 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 158), new LootPackItem(typeof(BaseClothing), 100)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsRichType2 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 128), new LootPackItem(typeof(BaseClothing), 100)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsFilthyRichType1 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 164), new LootPackItem(typeof(BaseClothing), 150)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsFilthyRichType2 = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 45),new LootPackItem(typeof(BaseClothing), 150)
		};
		...
		public static readonly LootPackItem[] AosMagicItemsUltraRich = new[]
		{
			...
			new LootPackItem(typeof(BaseJewel), 207), new LootPackItem(typeof(BaseClothing), 250)
		};

		public static readonly LootPackItem[] MyTestType = new[] 
		{
			new LootPackItem(typeof(BaseClothing), 1000), new LootPackItem(typeof(BaseClothing), 1)
		};
		#endregion
		...
		public static readonly LootPack SeFilthyRich =
			new LootPack(
				new[]
				{
					...
					new LootPackEntry(false, MyTestType, 100, 1, 7, 50, 100),
		...
		public static LootPack FilthyRich {
			get {Console.WriteLine("Test Balron filthy rich {0}", Core.SE ? 1 : Core.AOS ? 2 : 3);
			return Core.SE ? SeFilthyRich : Core.AOS ? AosFilthyRich : OldFilthyRich; } 
			}
		...
		public Item Mutate(Mobile from, int luckChance, Item item)
		{
			...
			if (item != null)
			{
				...
				if (item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat)
				{
					if (Core.AOS)
					{
                        Console.WriteLine("Test Balron generating with item {0}", itemname);
                        ...
                        {
                            Console.WriteLine("Test Balron generating with random item generator {0}", itemname);
							if (RandomItemGenerator.GenerateRandomItem(item, ((BaseCreature)from).LastKiller, (BaseCreature)from))
                                Console.WriteLine("Test Balron mutate return item {0} {1}", itemname, item);
								return item;
                        }
	...
	public class LootPackItem
	{
		...
		public Item Construct(bool inTokuno, bool isMondain, bool isStygian)
		{
			try
			{
				...
				if (m_Type == typeof(BaseClothing))
				{
					Console.WriteLine("Test Balron constructing cloth");
					item = Loot.RandomClothing(inTokuno, isMondain, isStygian );
					if (item == null) {
					Console.WriteLine("Test Balron constructing cloth failed");
					} else {
					Console.WriteLine("Test Balron constructing cloth success {0} {1}", item, item.Name);
					}
				}
