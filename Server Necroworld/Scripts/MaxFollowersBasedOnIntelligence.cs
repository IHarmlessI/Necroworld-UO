...
namespace Felladrin.Automations
{
    public static class MaxFollowersBasedOnIntelligence
    {
        ...
        {
            public static int IntelligenceCap = 200;      // What's the intelligence cap for players?
            public static int MinFollowersAllowed = 5;    // What's the minimum number of followers they can have?
            public static int MaxFollowersAllowed = 10;    // What's the maximum number of followers they can have?
        }
