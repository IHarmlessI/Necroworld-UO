...
{
    [CorpseName("a giant white beetle corpse")]
    public class WhiteBeetle : BaseMount
    {
        ...
        [Constructable]
        public WhiteBeetle(string name)
        ...
        public WhiteBeetle(Serial serial)
            : base(serial)
        {
        }
