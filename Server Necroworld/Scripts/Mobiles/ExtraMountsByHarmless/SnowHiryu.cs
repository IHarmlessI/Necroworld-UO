...
{
    [CorpseName("a snow hiryu corpse")]
    public class SnowHiryu : BaseMount
    {
        [Constructable]
                public SnowHiryu()
            : base("a snow hiryu", 243, 0x3E94, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Hue = 2062;
        ...
        public SnowHiryu(Serial serial)
            : base(serial)
        {
        }
