...
{
    [CorpseName("a lava dragon corpse")]
    public class LavaDragon : BaseMount
    {
            ...
            : base(name, 0x31A, 0x3EBD, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Anatomy, 75.1, 95.0);
        ...
        public LavaDragon(Serial serial)
            : base(serial)
        {
        }
