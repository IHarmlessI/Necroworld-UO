...
{
    [CorpseName("a swamp hiryu corpse")]
    public class swampHiryu : BaseMount
    {
        [Constructable]
                public swampHiryu()
            : base("a swamp hiryu", 243, 0x3E94, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Hue = 2180;
            ...
            SetSkill(SkillName.Anatomy, 75.1, 120.0);
            SetSkill(SkillName.MagicResist, 85.1, 140.0);
            ...
            if (Utility.RandomDouble() < .63)
                PackItem(Engines.Plants.Seed.RandomBonsaiSeed());

            if (Core.ML && Utility.RandomDouble() < .63)
        ...
        public swampHiryu(Serial serial)
            : base(serial)
        {
        }
