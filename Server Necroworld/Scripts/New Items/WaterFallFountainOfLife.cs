...
{
    [FlipableAttribute(0xA62D, 0xA630)]
    public class WaterFallFountainOfLife : BaseAddonContainer
    {
        private int m_Charges;
        private Timer m_Timer;
        [Constructable]
        public WaterFallFountainOfLife()
            : this(10)
        {
        }

        [Constructable]
        public WaterFallFountainOfLife(int charges)
            : base(0xA62D)
        {
            m_Charges = charges;
        ...
        public WaterFallFountainOfLife(Serial serial)
            : base(serial)
        {
        }
        ...
        public override BaseAddonContainerDeed Deed
        {
            get
            {
                return new WaterFallFountainOfLifeDeed(m_Charges);
            }
        }
    ...
    public class WaterFallFountainOfLifeDeed : BaseAddonContainerDeed
    {
        private int m_Charges;
        [Constructable]
        public WaterFallFountainOfLifeDeed()
            : this(10)
        {
        }

        [Constructable]
        public WaterFallFountainOfLifeDeed(int charges)
            : base()
        {
        ...
        public WaterFallFountainOfLifeDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        public override BaseAddonContainer Addon
        {
            get
            {
                return new WaterFallFountainOfLife(m_Charges);
            }
        }
        [CommandProperty(AccessLevel.GameMaster)]
        public int Charges
